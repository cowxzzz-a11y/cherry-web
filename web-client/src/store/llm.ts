...
export interface LlmState {
  ...
  defaultEmbeddingModel: Model | null
  defaultRerankModel: Model | null
...
const llmSlice = createSlice({
  ...
  reducers: {
    ...
    setDefaultEmbeddingModel: (state, action: PayloadAction<{ model: Model | null }>) => {
      state.defaultEmbeddingModel = action.payload.model
    },
    setDefaultRerankModel: (state, action: PayloadAction<{ model: Model | null }>) => {
      state.defaultRerankModel = action.payload.model
    },
